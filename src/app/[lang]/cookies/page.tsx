    ...
    <div className="min-h-screen">
      ...
      <section className="bg-white py-16 px-6 md:px-12">
        <div className="max-w-4xl mx-auto space-y-16 text-slate-700 leading-relaxed text-lg">
          ...
          <section>
            <h2 className="text-2xl font-bold text-slate-900 mb-6">{t.sections.s2_title}</h2>
            
            <div className="space-y-8">
              <div>
                <h3 className="font-bold text-slate-900 text-xl mb-2">{t.sections.s2_sub1_title}</h3>
                <p className="text-slate-600">
                  {t.sections.s2_sub1_text}
                </p>
              </div>
              
              <div>
                <h3 className="font-bold text-slate-900 text-xl mb-2">{t.sections.s2_sub2_title}</h3>
                <p className="text-slate-600">
                  {t.sections.s2_sub2_text}
                </p>
              </div>
            </div>
          </section>
