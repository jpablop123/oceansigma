      ...
      <section className="bg-[#0f172a] text-white pt-48 pb-16 px-6 md:px-12 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <span className="text-sm font-bold text-blue-400 tracking-wider uppercase">Compliance</span>
          </div>
      ...
      <section className="bg-white py-16 px-6 md:px-12">
        <div className="max-w-4xl mx-auto space-y-16 text-slate-700 leading-relaxed text-lg">
          ...
          <section>
            ...
            <p className="leading-8">{t.sections.s2_text}</p>
          </section>
          ...
          {/* Caja de Reporte */}
          <section className="bg-slate-50 p-8 border-l-4 border-blue-600">
            <h2 className="text-lg font-bold text-slate-900 uppercase tracking-wider mb-2">{t.sections.report_title}</h2>
            <p className="text-base mb-4 text-slate-600">
              {t.sections.report_text}
            </p>
